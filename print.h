...
int		ft_ecriture_zero_point_etoile_x_min(int i, int y,unsigned int nombre_charact_int, int len_int);
int		ft_ecriture_tiret_point_etoile_x(int i, int y,int len_int);
